...
online version: https://docs.microsoft.com/powershell/module/az.automanage/remove-azautomanageconfigurationprofileversion
schema: 2.0.0
---

# Remove-AzAutomanageConfigurationProfileVersion
...
### DeleteViaIdentity
```
Remove-AzAutomanageConfigurationProfileVersion -InputObject <IAutomanageIdentity> [-DefaultProfile <PSObject>]

...
online version: https://docs.microsoft.com/powershell/module/az.automanage/get-azautomanageconfigurationprofilehciassignment
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzAutomanageConfigurationProfileHciAssignment -ClusterName <String> -Name <String>

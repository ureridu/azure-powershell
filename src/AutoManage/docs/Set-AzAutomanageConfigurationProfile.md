...
online version: https://docs.microsoft.com/powershell/module/az.automanage/set-azautomanageconfigurationprofile
schema: 2.0.0
---

# Set-AzAutomanageConfigurationProfile
...
### Update
```
Set-AzAutomanageConfigurationProfile -Name <String> -ResourceGroupName <String>

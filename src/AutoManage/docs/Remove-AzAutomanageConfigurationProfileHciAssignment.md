...
online version: https://docs.microsoft.com/powershell/module/az.automanage/remove-azautomanageconfigurationprofilehciassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAutomanageConfigurationProfileHciAssignment -ClusterName <String> -Name <String>

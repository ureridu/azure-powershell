...
namespace Microsoft.Azure.PowerShell.AuthenticationAssemblyLoadContext
{
    public static class AzAssemblyLoadContextInitializer
    {
        ...
        static AzAssemblyLoadContextInitializer()
        {
            ...
            {
                {"Azure.Core", new Version("1.99.0.0")},
                {"Azure.Identity", new Version("1.99.0.0")},
                {"Azure.Identity.BrokeredAuthentication", new Version("1.99.0.0") },
                {"Microsoft.Bcl.AsyncInterfaces", new Version("1.1.1.0")},
                {"Microsoft.Identity.Client", new Version("4.99.0.0") },
                {"Microsoft.Identity.Client.Broker", new Version("4.99.0.0") },
                {"Microsoft.Identity.Client.Extensions.Msal", new Version("2.99.0.0") },
                {"Microsoft.Identity.Client.NativeInterop", new Version("0.99.0.0")},
                {"Microsoft.IdentityModel.Abstractions", new Version("6.99.0.0")},
